...
这是面向 ESP32-C3 与 1.54 英寸 ST7789 屏幕的离线星图固件，在设备本地计算太阳、月亮，以及地球之外七大行星（水星、金星、火星、木星、土星、天王星和海王星）的实时方位角与高度角，并显示从右向左的地平线刻度。土星带环；低于地平线的天体隐藏；升起和落下使用平滑过渡。
...
- 显示太阳、月亮、水星、金星、火星、木星、土星、天王星和海王星，以及方位角、高度角和附加信息。
